...
from lib.aruco_helper import create_aruco_params, create_charuco_params, aruco_detect_draw_get_transforms, show_matplotlib_all_aruco
...
if __name__ == '__main__':
    ...
    # show_matplotlib_all_aruco(aruco_dict)  # TODO function for charuco pdf?
